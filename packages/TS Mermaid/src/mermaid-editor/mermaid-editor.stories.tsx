import flowChart from "./flow-chart.mmd?raw";
import sequenceDiagram from "./sequence-diagram.mmd?raw";
import classDiagram from "./class-diagram.mmd?raw";
import stateDiagram from "./state-diagram.mmd?raw";
import entityRelationshipDiagram from "./entity-relationship-diagram.mmd?raw";
import userJourneyDiagram from "./user-journey-diagram.mmd?raw";
...
const ClassDiagram = {
	args: {
		initialValue: classDiagram,
	},
};

const StateDiagram = {
	args: {
		initialValue: stateDiagram,
	},
};
...
const EntityRelationshipDiagram = {
	...
	args: {
		initialValue: entityRelationshipDiagram,
	},
};

const UserJourneyDiagram = {
	args: {
		initialValue: userJourneyDiagram,
	},
};
